...
const MODES = [
  ...
  { id: "perimenopause", emoji: "🌡️", label: "Perimenopause", color: "border-amber-200 bg-amber-50/50 dark:border-amber-900 dark:bg-amber-950/20", activeColor: "border-amber-400 bg-amber-50 dark:border-amber-600 dark:bg-amber-950/40", fields: ["lmp", "hrt_type"] },
  { id: "menopause", emoji: "☀️", label: "Postmenopause", color: "border-orange-200 bg-orange-50/50 dark:border-orange-900 dark:bg-orange-950/20", activeColor: "border-orange-400 bg-orange-50 dark:border-orange-600 dark:bg-orange-950/40", fields: ["lmp", "hrt_type"] },
];
...
export default function QuickModeSwitcher({ currentCycleType, latestCycle, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={onClose}>
      ...
      <div
        className="relative w-full max-w-lg bg-background rounded-2xl border border-border shadow-2xl p-5 space-y-4 max-h-[85vh] overflow-y-auto"
